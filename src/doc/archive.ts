...
export const ARCHIVE = {
  ...
  famousCrimes: img("famous-crimes-discovery.jpg", 1612, 2400),
  pennySep8: img("ipn-1888-09-08-penny.jpg", 1570, 2400),
  ipnSep15: img("ipn-1888-09-15.jpg", 1744, 2400),
  ipnSep22: img("ipn-1888-09-22.jpg", 1671, 2400),
  ...
  pennyOct13: img("penny-1888-10-13.jpg", 2400, 1795),
  ...
  whitechapelMurdersFr: img("whitechapel-murders-fr.jpg", 1596, 2400),
  rueWhitechapelFr: img("rue-whitechapel-fr.jpg", 2400, 1741),
  // Documents
  ...
  colneyHatchIln: img("colney-hatch-2.jpg", 2400, 1701),
  // London
  ...
  parliament: img("parliament-from-river.jpg", 2400, 1801),
  parliamentSepia: img("parliament-lccn.jpg", 2400, 1882),
  // Maps
  ...
  boothLondon: img("booth-map-1889-wellcome.jpg", 2400, 2199),
  // People
